    ...
    fun fetchThemes() {
        viewModelScope.launch {
            ...
            try {
                ...
                // ⚡ Bolt Optimization: Instead of using flatMap { ... onEach { ... } } which creates
                // intermediate collections and loops multiple times, calculate the total size upfront
                // and use nested loops to populate an ArrayList with initial capacity. This avoids
                // redundant iterations and collection reallocations.
